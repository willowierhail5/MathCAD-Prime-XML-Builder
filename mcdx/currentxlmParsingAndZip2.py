...
def append_excels(root, var_names, file_names, ranges):
        ...
        with zipfile.ZipFile(
            ...
            for filename in myzip.namelist():
                if filename == "mathcad/result.xml":
                    ...
                    append_excels(root, excel_var_names, excel_file_names, excel_ranges)
                    append_evals(root, excel_var_names)
